...
- [Vagrant 1.9.1 has a network interface detection bug](https://github.com/mitchellh/vagrant/issues/8115). dcos-vagrant includes a patch to work around this issue.
- [Vagrant 1.8.7 has a problem with downloading boxes](https://github.com/mitchellh/vagrant/issues/7969). dcos-vagrant is incompatible with this version of Vagrant.
...
- [Vagrant 1.8.5 has an SSH key permissions bug](/docs/troubleshooting.md#ssh-authentication-failure). dcos-vagrant is incompatible with this version of Vagrant.
